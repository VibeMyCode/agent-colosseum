...
// Default IDL path: src/assets/agent_colosseum.idl
...
async function main() {
  const idlPath = process.argv[2] || resolve(FRONTEND_DIR, "src/assets/agent_colosseum.idl");
  ...
  try {
    ...
    console.error(`Expected path: frontend/src/assets/agent_colosseum.idl`);
    process.exit(1);
  }
  ...
  const idlRelPath = "src/assets/agent_colosseum.idl";
